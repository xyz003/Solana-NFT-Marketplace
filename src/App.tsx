                              ...
                              <AccountsProvider>
                                <Layout>
                                  <Switch>
                                    ...
                                    <Route
                                      exact
                                      path={ROUTES.CREATOR_GUIDES}
                                      children={
                                        <ResourceList category="Creator Guides" />
                                      }
                                    />
                                    <Route
                                      exact
                                      path={`${ROUTES.CREATOR_GUIDES}/:slug`}
                                      children={<ResourceView />}
                                    />
                                    <Route
                                      exact
